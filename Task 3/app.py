from task3_chat_session import ChatSession
import argparse
from task3_chat_session import console
from semantic_search_day3 import VectorStore
import sys
...
while True:
    ...
    token_counter.count_tokens(query, response)
