...
- If the retrieved context does not contain enough information, say that the
  knowledge base does not contain enough information to answer the question.
  Do not invent information.
- When answering a question using retrieved context, explicitly state that
...
SEARCH_PROMPT = """
The relevant context has already been retrieved from the knowledge base.

Answer the user's original question based on the provided context.
Always begin your answer by clearly stating that it is based on the provided
context.

Do not use your general knowledge to add information that is not supported
by the context.
